...
# Compute means and stds on training set
X_train_mean = X_train.mean(axis=0)
X_train_std = X_train.std(axis=0)
y_train_mean = y_train.mean()
y_train_std = y_train.std()

# Replace zero stds with 1.0 (preserves feature as constant/mean-centered)
X_train_std = X_train_std.replace(0, 1.0)
if y_train_std == 0:
    y_train_std = 1.0

# Centered and standardize
