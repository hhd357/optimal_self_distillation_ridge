...
# Load pretrained ResNet-18 and modify for feature extraction
...
K = 10
n_train = 2000 #20000 for CIFAR100
n_test = 2000 #10000 for CIFAR100
p = 512
...
ax.set_title('CIFAR10', fontsize=ftsize + 4)
